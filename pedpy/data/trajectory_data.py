...
class TrajectoryData:
    ...
    Attributes:
        data (pandas.DataFrame): data frame containing the trajectory data
            with the columns: "id", "frame", "x", "y", "point"
    ...
    def __getitem__(self, key):
        ...
        Returns:
            TrajectoryData: A new instance of TrajectoryData containing
                only the rows within the specified frame range.
        """
