...
from pedpy.data.geometry import MeasurementArea, WalkableArea, MeasurementLine
from pedpy.data.trajectory_data import TrajectoryData
from pedpy.methods.method_utils import (
    SpeedCalculation,
    compute_individual_voronoi_polygons,
    compute_intersecting_polygons, Cutoff,
)
...
def test_compute_line_speed(example_data):
    ...
    speed_on_line = compute_line_speed(individual_speed=speed, species=species,
...
def test_compute_species_correct_with_cutoff(bidirectional_setup):
    ...
    actual_species = compute_species(individual_voronoi_polygons=individual_cutoff,
...
def test_compute_species_correct_for_not_intersecting(non_intersecting_setup):
    ...
    actual = compute_species(individual_voronoi_polygons=individual_cutoff,
                             measurement_line=measurement_line,
                             frame_step=4,
                             trajectory_data=traj)
